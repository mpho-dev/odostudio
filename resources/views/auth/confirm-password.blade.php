...
@section('title', 'Validate Access — Odo Studio')
    ...
    <div class="relative z-20 w-full max-w-lg px-6 animate-hero-in">
        <div class="glass p-10 md:p-12 border border-charcoal/10 dark:border-white/10 shadow-2xl relative overflow-hidden group">
            ...
            <div class="text-center mb-10">
                <div class="text-[0.6rem] tracking-[0.4em] uppercase text-gold mb-4">Secure Zone</div>
                <h1 class="font-serif text-3xl text-charcoal dark:text-white mb-2 tracking-tight">Validate <em>Access</em></h1>
                <p class="text-[0.7rem] tracking-widest text-ash/60 dark:text-silver uppercase italic">Identity Verification Required</p>
            </div>

            <div class="mb-8 text-sm text-ash/80 dark:text-silver/80 leading-relaxed text-center italic">
                You are entering a protected sector of the studio. Please provide your password to confirm authorization.
            </div>
            ...
            <form method="POST" action="{{ route('password.confirm') }}" class="space-y-6">
                ...
                <div class="pt-4">
                    ...
                    <div class="text-center mt-8">
                        <a href="{{ url()->previous() }}" class="text-[0.6rem] tracking-widest uppercase text-ash/40 hover:text-gold transition-colors">Cancel Request</a>
                    </div>
                </div>
            </form>
        </div>
