...
@section('title', 'Join the Studio — Odo Studio')
    ...
    <div class="relative z-20 w-full max-w-lg px-6 animate-hero-in">
        <div class="glass p-10 md:p-12 border border-charcoal/10 dark:border-white/10 shadow-2xl relative overflow-hidden group">
            ...
            <div class="text-center mb-10">
                <div class="text-[0.6rem] tracking-[0.4em] uppercase text-gold mb-4">New Application</div>
                <h1 class="font-serif text-4xl text-charcoal dark:text-white mb-2 tracking-tight">Join the <em>Studio</em></h1>
                <p class="text-[0.7rem] tracking-widest text-ash/60 dark:text-silver uppercase italic">Curator & Creative Collective</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-6">
                ...
                <!-- Name -->
                <div class="space-y-2">
                    <label for="name" class="block text-[0.62rem] tracking-[0.3em] uppercase text-ash/60 dark:text-silver">Legal Name</label>
                ...
                <div class="pt-4">
                    ...
                    <div class="text-center mt-8">
                        <span class="text-[0.6rem] tracking-widest text-ash/60 dark:text-silver uppercase">Member already?</span>
                        <a href="{{ route('login') }}" class="ml-2 text-[0.6rem] tracking-widest uppercase text-gold border-b border-gold/30 hover:border-gold transition-all">Sign In</a>
                    </div>
                </div>
            </form>
        </div>
